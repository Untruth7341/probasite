...
(function () {
  ...
  var T = {
    ...
    /* ================= РУССКИЙ ================= */
    ru: {
      "meta.title": "Grikona — проверенное агентство недвижимости в Валенсии",
      "nav.how": "Как это работает",
      "nav.trust": "Доверие",
      "nav.pricing": "Цены",
      "nav.faq": "Вопросы",
      "nav.agencies": "Для агентств",
      "nav.cta": "Бесплатная оценка",
      "nav.menu": "Открыть меню",

      "hero.eyebrow": "Агентство недвижимости в Валенсии · RAICV-6201",
      "hero.h1": "Ваш дом в Валенсии — проверенный и без сюрпризов",
      "hero.lead": "Покупайте, продавайте или сдавайте в аренду с командой, которая проверяет каждый объект и сопровождает вас от первого просмотра до подписания. Никаких фантомных объявлений и завышенных комиссий.",
      "hero.cta1": "Хочу ранний доступ",
      "hero.cta2": "Как это работает",
      "hero.socialStrong": "Более 100 семей",
      "hero.socialText": "уже доверяют Grikona",

      "phone.demo": "ДЕМО",
      "phone.title": "Ваш следующий дом",
      "phone.subtitle": "Валенсия",
      "phone.feedback": "Свайпайте и находите",
      "phone.tagline": "Ваш дом начинается с Grikona Match",
      "phone.verified": "Проверено",
      "phone.stampLike": "НРАВИТСЯ",
      "phone.stampSkip": "ДАЛЕЕ",
      "deck.match": "Совпадение! ",
      "deck.discard": "Пропущено: ",

      "prop1.name": "Пентхаус в Русафе", "prop1.zone": "Русафа · Валенсия", "prop1.specs": "3 спальни · 95 м²",
      "prop2.name": "Квартира в Эль-Кармен", "prop2.zone": "Эль-Кармен · Валенсия", "prop2.specs": "2 спальни · 78 м²",
      "prop3.name": "Квартира в Эль-Кабаньяль", "prop3.zone": "Эль-Кабаньяль · Валенсия", "prop3.specs": "2 спальни · 70 м²",
      "prop4.name": "Вилла в Ла-Каньяда", "prop4.zone": "Ла-Каньяда · Валенсия", "prop4.specs": "4 спальни · 210 м²",
      "prop5.name": "Квартира в Бенимаклет", "prop5.zone": "Бенимаклет · Валенсия", "prop5.specs": "3 спальни · 88 м²",

      "strip.label": "Мы работаем в",

      "problem.eyebrow": "Проблема",
      "problem.h2": "Проблема рынка недвижимости — в качестве, а не в предложении",
      "problem.lead": "В Валенсии ежегодно продаются тысячи квартир. Но покупка, продажа или аренда по-прежнему медленные, дорогие и непрозрачные.",
      "problem.1.label": "объявлений на порталах — дубли или откровенные фантомы",
      "problem.1.title": "Вы ищете квартиру и теряете время",
      "problem.1.body": "Вы просматриваете фальшивые объявления, завышенные цены и контакты, которые не отвечают. Отправляете десятки сообщений и не знаете, доступна ли ещё квартира.",
      "problem.2.label": "обращений не имеют реального намерения купить",
      "problem.2.title": "Вы публикуете объявление, и вас заваливают любопытные",
      "problem.2.body": "Вы размещаете квартиру на портале и получаете десятки звонков от агентств, любопытных и людей, которые не могут купить или снять.",
      "problem.3.label": "часов средней работы на сделку: показы, звонки и документы",
      "problem.3.title": "Ведение сделки изматывает",
      "problem.3.body": "Показы, документы, переговоры и сопровождение. Узкое место — не поиск заинтересованных, а доведение сделки до конца без ошибок.",

      "solution.eyebrow": "Решение",
      "solution.h2": "Платформа для поиска. Команда для сопровождения.",
      "solution.lead": "Находите проверенное жильё с любого устройства, а сложное — показы, переговоры и документы — доверьте нашей команде.",
      "solution.appLabel": "Мобильное приложение · два профиля",
      "solution.seekers": "Ищущие",
      "solution.seekersH": "Найдите свой дом.",
      "solution.seekersP": "Открывайте жильё для покупки или аренды и общайтесь с тем, кто им управляет.",
      "solution.owners": "Собственники",
      "solution.ownersH": "Найдите того, кто его ищет.",
      "solution.ownersP": "Публикуйте жильё, получайте качественные обращения и выбирайте, сколько поддержки вам нужно.",
      "solution.appClosing": "Две стороны одной связи, в одном приложении.",
      "solution.dashLabel": "Веб-панель · Агентства",
      "solution.dashH": "Сопровождайте тех, кому нужна ваша помощь.",
      "solution.dashP": "Получайте заявки от собственников и управляйте объектами, командой и сопровождением из профессиональной панели.",
      "solution.dashLink": "Посмотреть панель",
      "solution.helpEyebrow": "Если вы публикуете жильё",
      "solution.helpH": "Профессиональная помощь начинается с вашего решения.",
      "solution.helpP": "Публикуя объявление, вы выбираете, как управлять недвижимостью. Так мы соединяем его с нужными специалистами.",
      "choice1": "Хочу помощь с самого начала",
      "choice1p": "Мы свяжем вас с проверенными агентами, которые работают в вашем районе и с вашим типом жилья. Они займутся показами, переговорами и всеми документами.",
      "choice2": "Сначала попробую сам",
      "choice2p": "Если выбрать этот вариант и не найти совпадение за разумный срок, подключится связь со специалистами. Вы решаете, оставить ли эту помощь готовой.",
      "choice3": "Предпочитаю управлять сам",
      "choice3p": "Вы публикуете и общаетесь с проверенными покупателями и арендаторами. Управление жильём полностью в ваших руках.",

      "trust.eyebrow": "Grikona / Доверие",
      "trust.title": "Доверие<br>с<br><span>первого дня.</span>",
      "trust.statement": "Построено на проверке,<br>а не на объёме.",
      "trust.intro": "Пока другие порталы ставят на количество, мы проверяем каждого человека и каждый объект перед публикацией.",
      "trust.verifTitle": "Уровни<br><strong>проверки.</strong>",
      "trust.v1t": "Проверенная личность", "trust.v1p": "Обязательная проверка документов и удостоверения личности каждого собственника.",
      "trust.v2t": "Реальные объявления", "trust.v2p": "Проверка в кадастре и физический осмотр объекта перед публикацией.",
      "trust.v3t": "Защита данных", "trust.v3p": "Безопасная инфраструктура и строгое соблюдение GDPR.",
      "trust.community": "Семей под сопровождением",
      "trust.fee": "Комиссия за привлечение в период запуска",

      "how.eyebrow": "Как это работает",
      "how.h2": "Ваша связь начинается в приложении",
      "how.lead": "Два профиля в одном приложении: ищите следующий дом или публикуйте жильё для продажи или аренды.",
      "how.tabSeekers": "Ищущие",
      "how.tabOwners": "Собственники",
      "how.s1t": "Расскажите, что ищете", "how.s1p": "Реальный бюджет, район, сроки. Наша система изучает ваши настоящие предпочтения, а не только отмеченные фильтры.",
      "how.s2t": "Получайте только проверенные объявления", "how.s2p": "Каждый объект проходит проверку личности, права собственности и качества. Никаких фантомных объявлений.",
      "how.s3t": "Связывайтесь напрямую", "how.s3p": "Когда есть соответствие — происходит мэтч. Прямой контакт с собственником или его агентом, без непрозрачных посредников.",
      "how.o1t": "Публикуйте жильё", "how.o1p": "Загрузите фото, данные и цену. Мы проверяем право собственности и помогаем установить конкурентную рыночную цену.",
      "how.o2t": "Получайте качественные обращения", "how.o2p": "Только проверенные люди с реальным намерением купить или снять. Вы решаете, как вести каждое обращение.",
      "how.o3t": "Закрывайте с поддержкой или сами", "how.o3p": "Ведите сделку сами или попросите помощи у нашей команды на любом этапе.",
      "how.dashEyebrow": "Для агентств · Веб-панель",
      "how.dashH": "У вашей профессиональной работы есть своё пространство.",
      "how.dashP": "Следите за обращениями, мэтчами и состоянием портфеля через аналитику панели.",
      "how.kpi1": "Обращений за месяц", "how.kpi2": "Активные мэтчи", "how.kpi3": "Портфель",
      "how.chartTitle": "Динамика обращений и мэтчей",
      "how.dashNote": "Реальная панель · Аналитика на демо-данных.",
      "dash.nav1": "Обзор", "dash.nav2": "Объекты", "dash.nav3": "Обращения", "dash.nav4": "Аналитика",

      "features.eyebrow": "Что нас отличает",
      "features.h2": "Связывать проще, когда есть доверие.",
      "feat.1t": "Проверка как продукт",
      "feat.1p": "Личность собственника, право собственности в кадастре и проверка качества объявления. Традиционные порталы не проверяют, потому что их модель зависит от объёма, а не от качества.",
      "feat.2t": "Мэтчинг по реальному намерению",
      "feat.2p": "Наша система анализирует реальный бюджет, сроки решения и допустимые компромиссы. Она показывает не то, что чаще кликают, а то, что действительно подходит.",
      "feat.3t": "Человеческое сопровождение",
      "feat.3p": "Приложение для ищущих и собственников и профессиональная команда, которая берёт на себя показы, переговоры и документы. Каждому профилю — нужная помощь.",
      "feat.4t": "Проверяемая репутация",
      "feat.4p": "Отзывы после взаимодействия и история сделок. Покупатель с тремя закрытыми сделками — не то же самое, что новичок. Доверие без дорогих посредников.",

      "pricing.eyebrow": "Цены",
      "pricing.h2": "Начните бесплатно. Растите в своём темпе.",
      "pricing.lead": "Без обязательств. Без сюрпризов. Платите только за нужное.",
      "plan1.label": "Приложение · Для частных лиц", "plan1.name": "Бесплатно",
      "plan1.f1": "Ограниченное число объявлений", "plan1.f2": "Ограниченные сообщения", "plan1.f3": "Базовая проверка",
      "plan1.cta": "Начать бесплатно",
      "plan2.label": "Приложение · Для активных собственников", "plan2.name": "Pro Individual",
      "plan2.f1": "До 5 активных объявлений", "plan2.f2": "Неограниченные сообщения", "plan2.f3": "Статистика эффективности", "plan2.f4": "Повышенная видимость",
      "plan2.cta": "Попробовать 14 дней бесплатно", "plan2.popular": "Самый популярный",
      "plan3.label": "Панель · Для агентств", "plan3.name": "Pro Agency",
      "plan3.f1": "Неограниченные объявления", "plan3.f2": "Панель с CRM", "plan3.f3": "Аналитика по агентам", "plan3.f4": "Премиум-размещение", "plan3.f5": "Доступ к opt-in-базе",
      "plan3.cta": "Попробовать 14 дней бесплатно",
      "pricing.note": "Также доступно: продвижение объявлений от 1,99 €/день, спецметки от 0,99 € и кредиты контактов от 0,50 €.",

      "cmp.eyebrow": "Сравнение",
      "cmp.h2": "Как выглядит Grikona на фоне других?",
      "cmp.h.feature": "Характеристика", "cmp.h.grikona": "Grikona", "cmp.h.portals": "Традиционные порталы", "cmp.h.digital": "Цифровые агентства",
      "cmp.r1": "Модель", "cmp.r1.g": "Проверенный маркетплейс + агентство", "cmp.r1.p": "Портал объявлений", "cmp.r1.d": "Цифровое агентство",
      "cmp.r2": "Проверка объявлений", "cmp.r2.g": "Личность + право собственности + осмотр", "cmp.r2.p": "Не проверяют (модель объёма)", "cmp.r2.d": "Только собственные объекты",
      "cmp.r3": "Комиссия со сделки", "cmp.r3.g": "0 % (этап запуска)", "cmp.r3.p": "Не применяется", "cmp.r3.d": "2–5 % от продажи",
      "cmp.r4": "Минимальный месячный платёж", "cmp.r4.g": "0 € (бесплатный план)", "cmp.r4.p": "От 300 €/мес", "cmp.r4.d": "Не применяется",
      "cmp.r5": "Умный мэтчинг", "cmp.r5.g": "По реальному намерению", "cmp.r5.p": "По фильтрам и платному размещению", "cmp.r5.d": "Внутреннее распределение",
      "cmp.r6": "Выбор помощи собственником", "cmp.r6.g": "Эксклюзивно", "cmp.r6.p": "Не существует", "cmp.r6.d": "Не существует",
      "cmp.r7": "Профессиональная панель", "cmp.r7.g": "CRM + аналитика по агентам", "cmp.r7.p": "Базовые инструменты", "cmp.r7.d": "Только внутреннее использование",
      "cmp.m.portals": "Порталы", "cmp.m.digital": "Цифровые агентства",

      "roadmap.eyebrow": "Планы",
      "roadmap.h2": "Видение, шаг за шагом",
      "roadmap.m1t": "Основание", "roadmap.m1p": "Grikona рождается в центре Валенсии. Первая команда, бренд и первые районные сделки.",
      "roadmap.m2t": "Консолидация", "roadmap.m2p": "Более 10 лет накопленного опыта и стабильный портфель в Русафе, Эль-Кармен и Эшампле.",
      "roadmap.m3t": "Цифровизация", "roadmap.m3p": "Начало разработки платформы: проверка документов, мэтчинг и панель для агентств.",
      "roadmap.m4t": "Проверенная платформа", "roadmap.m4p": "Запуск приложения и панели в Валенсии с первыми агентствами-партнёрами.",
      "roadmap.m5t": "Ориентир в Испании", "roadmap.m5p": "Экспансия в Аликанте, Кастельон, Малагу, Севилью и Бильбао. Новый способ работы в недвижимости.",
      "roadmap.vision": "«Жильё перестаёт быть головной болью и превращается в естественный, эффективный и дающий свободу опыт.»",

      "faq.eyebrow": "Вопросы",
      "faq.h2": "Частые вопросы",
      "faq.q1": "Что такое Grikona?", "faq.a1": "Grikona — агентство недвижимости в Валенсии, которое объединяет цифровую платформу проверенных объектов с профессиональной командой, сопровождающей вас при покупке, продаже или аренде.",
      "faq.q2": "Чем оно отличается от традиционных порталов?", "faq.a2": "Мы не публикуем непроверенные объявления. Мы проверяем личность собственника и право собственности, а также осматриваем объект перед публикацией. Так вы не тратите время на дубли и фантомные объявления.",
      "faq.q3": "Сколько стоит пользоваться Grikona?", "faq.a3": "Пользоваться приложением бесплатно. Для активных собственников план Pro Individual стоит 9,99 €/мес. Для агентств план Pro Agency — 49,99 €/мес. В период запуска мы не берём комиссию за привлечение.",
      "faq.q4": "Как вы проверяете объявления?", "faq.a4": "Мы применяем три уровня: проверенная личность (удостоверение и проверка документов), реальные объявления (проверка в кадастре и физический осмотр) и защита данных (безопасная инфраструктура и соблюдение GDPR).",
      "faq.q5": "В каких районах работает Grikona?", "faq.a5": "Мы начинаем в Валенсии и её агломерации: Русафа, Эль-Кармен, Эль-Кабаньяль, Бенимаклет, Эшампле, Сьютат-Велья, Куатре-Карререс и Ла-Каньяда и другие.",
      "faq.q6": "Могу ли я выбрать, нужна ли мне помощь агентства?", "faq.a6": "Да. При публикации вы выбираете: сопровождение с самого начала, самостоятельную попытку с запасной помощью или полное управление своими силами.",
      "faq.q7": "Как присоединиться?", "faq.a7": "Запишитесь в список ожидания через форму на этой странице. Мы сообщим, как только откроется ранний доступ в Валенсии.",

      "cta.waitlist": "Уже более 100 в списке ожидания",
      "cta.h2": "Ваша следующая связь — в одном <span class=\"mow\" aria-hidden=\"true\"></span> от вас",
      "cta.p": "Ищете жильё или публикуете своё — присоединяйтесь к раннему доступу. Мы начинаем в Валенсии.",
      "cta.placeholder": "vy@email.com",
      "cta.button": "Хочу доступ",
      "cta.done": "Вы записаны!",
      "cta.meta": "Запуск в Валенсии · 2026<br>Хотите связаться напрямую? <a href=\"mailto:info@grikona.com\">info@grikona.com</a>",

      "footer.desc": "Платформа для поиска и публикации жилья. Команда, сопровождающая вас при покупке, продаже и аренде в Валенсии.",
      "footer.nav": "Навигация",
      "footer.contact": "Контакты",
      "footer.copy": "© 2026 Grikona · Зарегистрированное агентство недвижимости RAICV-6201",
      "footer.privacy": "Политика конфиденциальности",
      "footer.terms": "Условия использования",
      "footer.cookies": "Cookies",

      "chat.title": "Поддержка Grikona",
      "chat.status": "Онлайн · отвечаем за минуты",
      "chat.welcome": "Здравствуйте! 👋 Я ассистент Grikona. Чем могу помочь сегодня?",
      "chat.placeholder": "Введите сообщение...",
      "chat.send": "Отправить",
      "chat.quick1": "Хочу купить", "chat.quick2": "Хочу снять", "chat.quick3": "Хочу продать",
      "chat.replyBuy": "Отлично! Расскажите район и примерный бюджет, и мы пришлём проверенные варианты.",
      "chat.replyRent": "Хорошо! Скажите район и желаемую месячную аренду, и мы покажем доступные варианты.",
      "chat.replySell": "Мы можем бесплатно оценить ваше жильё. Оставите email или телефон?",
      "chat.replyDefault": "Спасибо за сообщение. Консультант Grikona ответит в ближайшее время. Также можете оставить email.",
      "chat.launcherAria": "Открыть чат поддержки",
  ...
  var AG = {
    es: {
      ...
      "ag.demo.done": "¡Solicitud enviada!",
    ...
    ru: {
      "ag.meta.title": "Для агентств — Панель Grikona",
      "ag.breadcrumb": "Главная / Для агентств",
      "ag.hero.h1": "Панель для агентств, которые хотят привлекать больше объектов",
      "ag.hero.p": "Получайте заявки от собственников, выбравших работу со специалистами, управляйте командой и следите за каждым объектом с одной панели.",
      "ag.hero.cta1": "Запросить демо",
      "ag.hero.cta2": "Смотреть цены",
      "ag.dash.eyebrow": "Веб-панель",
      "ag.dash.h2": "Весь ваш бизнес на одном экране",
      "ag.dash.lead": "Аналитика по агентам, статус каждого объекта в реальном времени и лёгкая CRM для агентств.",
      "ag.how.eyebrow": "Как это работает",
      "ag.how.h2": "От заявки до объекта",
      "ag.s1t": "Настройте профиль агентства", "ag.s1p": "Район, типы объектов, ценовой диапазон и специализация. Система назначает вам только объекты, подходящие вашему портфелю.",
      "ag.s2t": "Получайте собственников, которым нужна ваша помощь", "ag.s2p": "Приходят заявки от собственников, выбравших работу со специалистами и чей объект соответствует вашей деятельности.",
      "ag.s3t": "Управляйте из панели", "ag.s3p": "Лёгкая CRM, аналитика по агентам и статус каждого объекта в реальном времени. Всё в веб-приложении для агентств.",
      "ag.adv.eyebrow": "Преимущества",
      "ag.adv.h2": "Почему агентства выбирают Grikona",
      "ag.a1t": "Качественные лиды", "ag.a1p": "Только проверенные собственники с реальным намерением продать или сдать. Холодные звонки остались в прошлом.",
      "ag.a2t": "Экономия времени", "ag.a2p": "Автоматизируйте сопровождение и сосредоточьтесь на показах и закрытии. Меньше рутины — больше сделок.",
      "ag.a3t": "Проверенный бренд", "ag.a3p": "Показывайтесь как надёжное агентство на платформе и укрепляйте репутацию в глазах собственников.",
      "ag.a4t": "Без входной платы", "ag.a4p": "Начните с 14-дневного пробного периода. Без обязательств и с понятной месячной платой, которую можно отменить в любой момент.",
      "ag.demo.eyebrow": "Запросить демо",
      "ag.demo.h2": "Узнайте панель за 20 минут",
      "ag.demo.lead": "Расскажите о себе, и мы покажем, как Grikona может наполнить ваш портфель проверенными объектами.",
      "ag.demo.agency": "Название агентства",
      "ag.demo.email": "Контактный email",
      "ag.demo.zone": "Город / район",
      "ag.demo.cta": "Запросить демо",
      "ag.demo.done": "Заявка отправлена!",
      "ag.cta.h2": "Готовы привлекать проверенные объекты?",
      "ag.cta.p": "Присоединяйтесь к агентствам, уже работающим с Grikona в Валенсии.",
      "ag.cta.btn1": "Запросить демо",
      "ag.cta.btn2": "Напишите нам"
    }
  };
